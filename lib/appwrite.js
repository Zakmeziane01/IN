...
export const updateUserAdditionalInfo = async (userId, firstName, lastName, birthday) => {
  try {
    const updatedUser = await databases.updateDocument(
      config.databaseId,
      config.userCollectionId,
...
export const MyGender = async (userId,gender) => {
  try {
    const updatedUser = await databases.updateDocument(
      config.databaseId,
      config.userCollectionId,
...
export const UserCareer = async (userId,career) => {
  try {
    const updatedUser = await databases.updateDocument(
      config.databaseId,
      config.userCollectionId,
...
export const WorkRoles = async (userId,employmentRoles) => {
  try {
    const updatedUser = await databases.updateDocument(
      config.databaseId,
      config.userCollectionId,
...
export const EducationRoles = async (userId, course , university) => {
  try {
    const updatedUser = await databases.updateDocument(
      config.databaseId,
      config.userCollectionId,
...
export const ProjectChoice = async (userId, projectDivision) => {
  try {
    const updatedUser = await databases.updateDocument(
      config.databaseId,
      config.userCollectionId,
