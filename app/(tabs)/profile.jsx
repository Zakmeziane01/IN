...
import { getUserAttributes } from '../../lib/appwrite'; 
  ...
  useEffect(() => {
    const fetchUserAttributes = async () => {
      try {
        ...
        console.log(attributes.photoProfile);
         
        // Set profile image URI and user attributes
        setProfileImageUri(attributes.photoProfile); 
      ...
      >
        ...
        <View className="shadow-md">
          ...
          <Text className="font-pregular text-xl mt-7">
            <Text className="font-psemibold">About Me: </Text>{userAttributes?.aboutYou || 'N/A'}
          </Text>
